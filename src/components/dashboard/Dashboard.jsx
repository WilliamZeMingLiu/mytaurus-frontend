                ...
                <div id="assetContainer">
                    <Card className="assetCard">
                        <CardContent>
                            ...
                            <Chip
                                label="+ $1,178.12 (12.30%)"
                                className="assetBadge"
                                color="primary"
                                style={{ backgroundColor: "#27ae60", fontSize: 16}}
                            />
                        </CardContent>
                    </Card>
                            ...
                            <Table>
                                ...
                                <TableBody>
                                    <TableRow>
                                        ...
                                        <TableCell><span style={{ color: "red" }}>-0.02%</span></TableCell>
                                    </TableRow>
                                    <TableRow>
                                        ...
                                        <TableCell><span style={{ color: "red" }}>-0.76%</span></TableCell>
                                    </TableRow>
                                    <TableRow>
                                        ...
                                        <TableCell><span style={{ color: "red" }}>-4.03%</span></TableCell>
                                    </TableRow>
                                    <TableRow>
                                        ...
                                        <TableCell><span style={{ color: "red" }}>-1.66%</span></TableCell>
                                    </TableRow>
                                </TableBody>
                            </Table>
                        </TableContainer>
